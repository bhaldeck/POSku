...
<section class="content">
	...
	<div class="box">
        <div class="box-header with-border">
            ...
            <a href="<?=site_url('stok/out') ?>" class="btn btn-success btn-flat">
                ...
                <div class="col-md-4 col-md-offset-2">
                    <form action="<?=site_url('stok/process') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="detail" id="detail" class="form-control" placeholder="Rusak / Kadaluarsa / dsb" required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" name="out_add" class="btn btn-primary btn-flat">Simpan</button>
